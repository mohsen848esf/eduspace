...
export const AdminDashboardView: React.FC<AdminDashboardViewProps> = ({
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-2 sm:px-4 md:px-6 py-4 flex flex-col gap-6 fade-in text-[var(--t1)]">
      ...
      <div className="w-full relative overflow-hidden rounded-2xl p-5 md:p-6 bg-gradient-to-r from-[var(--s2)] to-[var(--s3)] border border-[var(--b)] shadow-md flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        {/* Right in RTL: Welcome Greeting & Message */}
        <div className="flex flex-col min-w-0 text-start">
          <div className="flex items-center gap-2">
            <h2 className="text-lg md:text-xl font-black text-[var(--t1)] flex items-center gap-2">
              <span>{isFarsi ? "خوش آمدید" : "Welcome back"}</span>
              <span className="text-xl">✋</span>
              <span>{isFarsi ? `، ${userName}` : `, ${userName}`}</span>
            </h2>
          </div>
          <p className="text-xs text-[var(--t3)] mt-1.5 font-medium truncate">
            {isFarsi
        ...
        <div className="flex items-center gap-3.5 self-stretch md:self-auto justify-end" dir="ltr">
          <div className="w-12 h-12 rounded-2xl bg-[var(--brand)] flex items-center justify-center text-[var(--brand-dark,#04140F)] font-black text-2xl shadow-lg shadow-[var(--brand)]/25 flex-shrink-0 overflow-hidden">
            {activeOrg?.logo ? (
              <img
          ...
          <div className="flex flex-col text-left">
            <span className="text-base md:text-[17px] font-extrabold text-[var(--t1)] leading-tight truncate">
              {orgName}
            </span>
            <span className="text-xs text-[var(--t3)] font-medium mt-1 leading-none truncate">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
        ...
        <div className="bg-[var(--s2)] border border-[var(--b)] hover:border-[var(--brand)] hover:bg-[var(--s3)] rounded-2xl p-4 flex flex-col justify-between items-center text-center transition-all duration-200 shadow-md group">
          ...
          <div className="my-2">
            <span className="text-2xl md:text-3xl font-black text-[var(--t1)] font-mono">
              {classesCount}
            </span>
          </div>
        ...
        <div className="bg-[var(--s2)] border border-[var(--b)] hover:border-[var(--brand)] hover:bg-[var(--s3)] rounded-2xl p-4 flex flex-col justify-between items-center text-center transition-all duration-200 shadow-md col-span-2 sm:col-span-1 group">
          <div className="w-full flex items-center justify-between">
            <span className="text-xs font-bold text-[var(--t2)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-[var(--s2)] border border-[var(--b)] rounded-3xl p-5 md:p-6 flex flex-col justify-between shadow-md">
          ...
          <div className="grid grid-cols-2 gap-2.5 border-t border-[var(--b)] pt-3.5 text-xs font-bold">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[var(--amber,#FFB000)] shadow-sm" />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[var(--cyan,#06B6D4)]" />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[var(--red,#FF4D5D)]" />
        ...
        <div className="lg:col-span-7 bg-[var(--s2)] border border-[var(--b)] rounded-3xl p-5 md:p-6 flex flex-col justify-between shadow-md">
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <div className="flex items-center gap-3 text-xs font-bold">
              ...
              <div className="flex items-center gap-1.5">
                <span className="w-2.5 h-2.5 rounded-full bg-[var(--amber,#FFB000)]" />
            ...
            <svg className="w-full h-full" viewBox="0 0 340 160" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {[0, 40, 80, 120].map((y) => (
                <line
                  ...
                  x2="330"
                  y2={y + 10}
                  stroke="var(--b-soft, var(--b))"
                  strokeWidth="0.8"
                  strokeDasharray="3 3"
                />
              ))}
              <path d={revPath} stroke="var(--brand)" strokeWidth="3" strokeLinecap="round" />
              <path d={`${revPath} L 320 150 L 25 150 Z`} fill="url(#brandGrad)" />
              <path d={expPath} stroke="var(--amber, #FFB000)" strokeWidth="2.5" strokeLinecap="round" />
              ...
              {expensePoints.map((p, idx) => (
                <circle key={idx} cx={p.x} cy={p.y} r="3" fill="var(--s1)" stroke="var(--amber, #FFB000)" strokeWidth="2" />
              ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[var(--s2)] border border-[var(--b)] rounded-3xl p-5 flex flex-col justify-between shadow-md">
          ...
          <div className="flex flex-col gap-3 my-3">
            <div className="bg-[var(--s3)] border border-[var(--b)] rounded-2xl p-3 flex items-center justify-between gap-3">
