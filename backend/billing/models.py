...
class SubscriptionPlan(models.Model):
    ...
    max_meeting_participants = models.IntegerField(default=25)
    max_group_duration_minutes = models.IntegerField(default=60)  # 60 min for free; 0 or 1440 for unlimited
